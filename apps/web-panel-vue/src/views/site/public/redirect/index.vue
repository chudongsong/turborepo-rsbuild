...
import { configPopup, changeStatus, configContent, configPath, contentLoading, delRedirect, editRedirectEvent, errorRedirectEvent, getRedirectFile, helpList, initRedirect, saveFile, useBatchEventHandle } from './useController'
import { useSiteRedirectStore } from './useStore'
...
const { BtTable, BtRefresh, BtBatch, refresh } = useTable({
