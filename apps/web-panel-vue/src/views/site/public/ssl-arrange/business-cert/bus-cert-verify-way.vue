<template>
	<div class="p-[5rem]">
		...
		<!-- 验证方式 -->
		<div class="mt-[20px]">
			<el-button type="primary" @click="verifyDomain()">验证域名</el-button>
			<el-button type="default" @click="setVerifyType(emits('close'))"> 修改验证方式 </el-button>
			<el-button type="default" @click="emits('close')">返回列表</el-button>
		</div>
	</div>
</template>
...
import { domains, helpList, initCertData, setVerifyType, urlTableData, verifyDomain, wayType } from './useCertController'
import { tableColumn } from './useOtherController'
