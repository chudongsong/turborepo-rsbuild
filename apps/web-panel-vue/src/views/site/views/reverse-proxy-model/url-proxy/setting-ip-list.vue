...
import { proxyData, tabActive, settingIpRef, settingIpWhiteRef, listData, setIpValueEvent, initIpData, ipTableColumns, TableBatchOptions, addIpView } from './useController'
