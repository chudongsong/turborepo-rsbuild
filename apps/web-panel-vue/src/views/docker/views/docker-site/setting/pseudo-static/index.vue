		...
		<div v-bt-loading="textLoading" v-bt-loading:title="'正在加载内容，请稍候...'">
			<div class="flex items-center justify-between">
				...
				<span class="flex items-center"
					>规则转换工具：
					<bt-link class="bt-link" href="https://www.bt.cn/Tools">Apache转Nginx <i class="svgtofont-el-link"></i></bt-link>
				</span>
			</div>
			<div class="my-[12px]">
			...
			<div>
				...
				<el-button @click="openSaveView">另存为模板</el-button>
			</div>
...
import { textLoading, textValue, helpList, optionData, staticContent, isClose, handleChange, initPseudoStatic, setReWriteBody, delPseudoStatic, setOtherTemplate } from './useController'
