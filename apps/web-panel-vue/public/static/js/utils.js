...
var bt = {
  ...
  render_ps: function (item) {
    ...
    html +=
      '<p style="margin-bottom: 19px; margin-top: 11px; color: var(--el-color-text-secondary)"></p>';
    return html;
  },
        ...
        '<div class="service_consult">\
						...
						<div class="contact_consult" style="margin: 10px auto 8px auto;">\
							<div id="contact_consult_qcode">\
								<img style="border: none;width: 140px;display: inline;" src="/static/images/customer/customer-qrcode.png" alt="" />\
							</div>\
						</div>\
