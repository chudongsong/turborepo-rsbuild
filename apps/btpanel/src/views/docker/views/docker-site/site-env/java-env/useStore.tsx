...
const DOCKER_SITE_ENV_JAVA_STORE = defineStore('DOCKER-SITE-ENV-JAVA-STORE', () => {
...
const useDockerSiteEnvStore = () => {
  return storeToRefs(DOCKER_SITE_ENV_JAVA_STORE());
};

export { DOCKER_SITE_ENV_JAVA_STORE, useDockerSiteEnvStore };
