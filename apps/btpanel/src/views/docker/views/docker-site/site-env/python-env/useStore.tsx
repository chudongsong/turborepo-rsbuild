...
const DOCKER_SITE_ENV_PYTHON_STORE = defineStore('DOCKER-SITE-ENV-PYTHON-STORE', () => {
...
const useDockerSiteEnvStore = () => {
  return storeToRefs(DOCKER_SITE_ENV_PYTHON_STORE());
};

export { DOCKER_SITE_ENV_PYTHON_STORE, useDockerSiteEnvStore };
