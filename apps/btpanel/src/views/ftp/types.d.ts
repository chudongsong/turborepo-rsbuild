...
// FTP修改状态接口
export interface FtpEditStausProps {
	id: number
	username: string
	status: number
}
...
interface FtpTableEventProps {
	...
	deleteDataEvent: (row: FtpTableDataProps, isConfirm: boolean) => Promise<void>
...
export interface FtpLogTableEventProps {
	...
	deleteDataEvent: (row: FtpLogTableDataProps, isConfirm: boolean) => Promise<void>
