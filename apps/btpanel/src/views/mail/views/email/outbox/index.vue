	...
	<div>
		<bt-table-group>
			...
			<template #footer-right>
				<!-- <bt-table-page v-model:page="search.p" :layout="'prev, pager, next, total'" v-model:total="table.total"
					@change="getList"> </bt-table-page> -->
...
import { getList, refresh } from '@mail/views/email/outbox/useMethod'

const { search, table, senderRef } = storeToRefs(MAIL_OUTBOX())
const { columns, reset } = MAIL_OUTBOX()
