<template>
	<bt-table-group class="px-[1.6rem] py-[1.6rem]">
		...
		<template #content>
			<bt-table max-height="260" :column="tableColumn" :data="tableData" v-bt-loading="loading" :description="'词库列表为空'" v-bt-loading:title="'正在加载词库列表，请稍后...'"></bt-table>
		</template>
		<template #popup>
...
import { addThesaurus, clearThesaurus, delThesaurus, getThesaurus, outThesaurus } from '@/api/firewall'
...
const addThesaurusRef = ref(null) // 添加弹窗
